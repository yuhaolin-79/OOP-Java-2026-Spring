...
public class XMLSalesFormatter implements SalesFormatter {
   ...
   public String formatSales(Sales var1) {
      ...
      for(Iterator var3 = var1.getOrdersIterator(); var3.hasNext(); var2 = var2 + "  </Order>" + NEW_LINE) {
         Order var4 = (Order)var3.next();
         var2 = var2 + "  <Order total=\"" + var4.getTotalCost() + "\">" + NEW_LINE;

         OrderItem var6;
         for(Iterator var5 = var4.getItemsIterator(); var5.hasNext(); var2 = var2 + "    <OrderItem quantity=\"" + var6.getQuantity() + "\" price=\"" + var6.getProduct().getPrice() + "\">" + var6.getProduct().getCode() + "</OrderItem>" + NEW_LINE) {
